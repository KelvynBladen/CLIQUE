...
ggplot(df, aes(v1, y, colour = v3 > 0)) + geom_point(size = 2)
...
ggsave("regint_patch.jpg", dpi = 1200, width = 4.4, height = 4.4)

gl + gs + gi + gq + 
  plot_layout(guides = "collect", axes = "collect") &
  ggeasy::easy_add_legend_title("v3 > 0")

ggsave("regint_patch_1col.pdf", dpi = 1600, width = 5.5, height = 3.3)
